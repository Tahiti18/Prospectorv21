...
// CONFIRMED: Locked to Gemini 3.0 Flash for maximum consistency
...
const SYSTEM_BOOTSTRAP = `You are Prospector OS. Output ONLY valid JSON. Provide exhaustive, detailed content. No generic placeholders.`;
