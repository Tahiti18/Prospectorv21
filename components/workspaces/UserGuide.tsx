...
const MODULE_REGISTRY: ModuleDetail[] = [
  ...
  { id: 'STRATEGY_CENTER', mode: 'RESEARCH', title: 'Strategic Hub', mission: 'The primary workspace for individual lead analysis. It consolidates vulnerability audits and transformation opportunities into a single, actionable strategic interface.', input: 'Prospect Identity & Digital Footprint', output: 'Transformation Blueprint', useCase: 'Deep-dive preparation for high-stakes sales calls.', tags: ['Strategy', 'Audit'] },
  { id: 'STRATEGIC_REASONING', mode: 'RESEARCH', title: 'Strategic Reasoning', mission: 'An advanced cognitive engine optimized for solving complex strategic hurdles, objection handling, and architecting unique competitive advantages.', input: 'Business Challenges & Context', output: 'Structured Logical Solutions', useCase: 'Overcoming specific client roadblocks during closing.', tags: ['Reasoning', 'Logic'] },
  ...
  { id: 'MARKET_TRENDS', mode: 'RESEARCH', title: 'Industry Monitor', mission: 'A live intelligence stream that monitors global news and cultural shifts to ensure your outreach messaging remains grounded and relevant to current events.', input: 'Web Grounding & Industry Keywords', output: 'Market Insight Reports', useCase: 'Aligning marketing angles with real-time cultural signals.', tags: ['Viral', 'Grounding'] },
  { id: 'VISUAL_ANALYSIS', mode: 'RESEARCH', title: 'Aesthetic Audit', mission: 'A multi-modal audit engine that analyzes website screenshots to grade design quality, brand authority, and visual conversion effectiveness.', input: 'Static Image / Site Screenshot', output: 'Design Grade & Sentiment Analysis', useCase: 'Identifying aesthetic deficits to sell creative revamps.', tags: ['Vision', 'Research'] },
  { id: 'VIDEO_INSIGHTS', mode: 'RESEARCH', title: 'Content Lab', mission: 'Deep temporal analysis of video content to deconstruct narratives and viral potential. It benchmarks content against industry-leading performance standards.', input: 'Video URL (YouTube/Vimeo)', output: 'Structural Deconstruction', useCase: 'Refining content strategy and identifying media gaps.', tags: ['Video', 'Intel'] },
  ...
  { id: 'BENCHMARK', mode: 'RESEARCH', title: 'Analysis Center', mission: 'A technical deconstruction tool that analyzes a competitor\'s tech stack, design system, and business model to highlight exploitable infrastructure gaps.', input: 'Competitor Digital Node', output: 'Comparative Gap Analysis', useCase: 'Competitive positioning and market disruption strategy.', tags: ['Analysis', 'Tech'] },
  ...
  // --- DESIGN ZONE ---
  { id: 'VISUAL_STUDIO', mode: 'DESIGN', title: 'Asset Lab', mission: 'A high-end asset generation engine producing professional brand imagery, commercial photography, and ad creatives from pure text descriptions.', input: 'Aesthetic Directives & Brand Style', output: '4K Commercial Renders', useCase: 'Producing unique, high-fidelity brand assets for ads.', tags: ['Creative', 'Design'] },
  { id: 'BRAND_DNA', mode: 'DESIGN', title: 'Identity Profile', mission: 'Instantly extracts core identity markers—including colors, typography, and archetype—from any URL to maintain visual consistency in new assets.', input: 'Target Website URL', output: 'Comprehensive brand identity matrix', useCase: 'Client brand alignment.', tags: ['Extraction', 'Branding'] },
  { id: 'MOCKUPS_4K', mode: 'DESIGN', title: 'Visualization', mission: 'A commercial visualization forge that creates photorealistic 4K renders of products or services in premium environment settings.', input: 'Product and setting details', output: '4K commercial renders', useCase: 'High-end visual proof.', tags: ['3D', 'Sales'] },
  { id: 'PRODUCT_SYNTHESIS', mode: 'DESIGN', title: 'Offer Design', mission: 'Synthesizes market data and client capabilities into high-ticket service bundles, defining price points and value-stack hierarchies.', input: 'Service Data & Niche Context', output: 'Structured Value Diagram', useCase: 'Re-engineering low-value offers into high-ticket sales.', tags: ['Offer', 'Design'] },
  { id: 'CONTENT_IDEATION', mode: 'DESIGN', title: 'Creative Sparks', mission: 'A high-volume brainstorming engine that generates hundreds of creative hooks, viral themes, and editorial concepts for multi-platform social media.', input: 'Brand objective, niche context', output: 'Categorized creative concepts', useCase: 'Editorial calendar planning.', tags: ['Ideas', 'Creative'] },
  { id: 'ASSET_LIBRARY', mode: 'DESIGN', title: 'Media Archive', mission: 'The central reservoir for all images, videos, and text files created in the OS.', input: 'Generated media assets', output: 'Organized asset repository', useCase: 'Digital asset management.', tags: ['Storage', 'Files'] },
  ...
  { id: 'VIDEO_AUDIT', mode: 'MEDIA', title: 'Media Review', mission: 'Critiques existing video content for pacing, design, and engagement.', input: 'Video link or raw file', output: 'Professional creative audit', useCase: 'Improving client media quality.', tags: ['Critique', 'Media'] },
  { id: 'MOTION_LAB', mode: 'MEDIA', title: 'Storyboarding', mission: 'Architects animated storyboards and dynamic plans for video production.', input: 'Narrative script', output: 'Animated storyboard visualization', useCase: 'Pre-production architecture.', tags: ['Animation', 'Storyboard'] },
  { id: 'SONIC_STUDIO', mode: 'MEDIA', title: 'Audio Engineering', mission: 'Generates professional voiceovers and background soundtracks for media.', input: 'Script, genre, vocal directive', output: 'Studio-quality audio files', useCase: 'Media soundtracking.', tags: ['Audio', 'Music'] },
  { id: 'MEETING_NOTES', mode: 'MEDIA', title: 'Transcription', mission: 'Converts raw meeting transcripts into organized action items and summaries.', input: 'Meeting transcript/audio', output: 'Executive summary and tasks', useCase: 'Post-meeting synchronization.', tags: ['Workflow', 'Scribe'] },
  ...
  { id: 'PROPOSALS', mode: 'OUTREACH', title: 'Agreement Builder', mission: 'Generates strategic proposals via interactive high-conversion "Magic Links."', input: 'Deal terms, service scope', output: 'Interactive proposal link', useCase: 'Closing high-ticket deals.', tags: ['Closing', 'Agreements'] },
  { id: 'ROI_CALCULATOR', mode: 'OUTREACH', title: 'Value Analysis', mission: 'Mathematical modeling to quantify the financial impact of transformation.', input: 'Business metrics (LTV, volume)', output: 'ROI and growth report', useCase: 'Financial value justification.', tags: ['Math', 'Finance'] },
  { id: 'SEQUENCER', mode: 'OUTREACH', title: 'Outreach Manager', mission: 'Architects multi-channel follow-up flows for sustained engagement.', input: 'Initial outreach strategy', output: 'Multi-day engagement schedule', useCase: 'Nurture flow automation.', tags: ['Email', 'Outreach'] },
  { id: 'AI_CONCIERGE', mode: 'OUTREACH', title: 'Client Relations', mission: 'An interactive proof-of-concept for autonomous customer engagement. It demonstrates how an AI agent can handle inquiries and book meetings 24/7.', input: 'Agency/Business Knowledge Base', output: 'Nurture Dialogue Simulation', useCase: 'Demonstrating AI service value in a live environment.', tags: ['Agent', 'Demo'] },
  { id: 'ELEVATOR_PITCH', mode: 'OUTREACH', title: 'Value Scripting', mission: 'Crafts high-impact, 30-second introductory scripts designed to rapidly communicate value and capture interest during cold outreach.', input: 'Business Profile & Offer DNA', output: 'Short-Form Value Script', useCase: 'Cold calling and introductory messaging.', tags: ['Hook', 'Intro'] },
  { id: 'FUNNEL_MAP', mode: 'OUTREACH', title: 'Journey Mapping', mission: 'Visualizes the conversion pathway and intent journey for a campaign, mapping every step from initial ad to finalized contract.', input: 'Operational logic & Conversion goals', output: 'Visual Funnel Flowchart', useCase: 'Analyzing and optimizing conversion pathways.', tags: ['Map', 'Logic'] }
];
