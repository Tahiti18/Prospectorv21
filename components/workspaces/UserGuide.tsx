...
const MODULE_REGISTRY: ModuleDetail[] = [
  ...
  { id: 'MOCKUPS_4K', mode: 'DESIGN', title: 'Mockup Studio', mission: 'A commercial visualization forge that creates photorealistic 4K renders of products or services in premium environment settings.', input: 'Product and setting details', output: '4K commercial renders', useCase: 'High-end visual proof.', tags: ['3D', 'Sales'] },
