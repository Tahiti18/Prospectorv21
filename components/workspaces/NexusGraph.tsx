    ...
    <div className="max-w-6xl mx-auto py-8 space-y-12 animate-in fade-in duration-500">
      <div className="flex justify-between items-end border-b border-slate-800/50 pb-8">
        <div>
          ...
          <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.4em] mt-2 italic">Market Entity Relationship Matrix ({leads.length} Nodes)</p>
        </div>
      ...
      <div className="bg-[#0b1021] border border-slate-800 rounded-[56px] p-4 shadow-2xl relative min-h-[600px] overflow-hidden flex items-center justify-center">
         ...
         {leads.length === 0 ? (
            <div className="text-center opacity-30 animate-pulse">
               ...
               <p className="text-[10px] text-slate-700 uppercase tracking-widest mt-4">Generate leads in Lead Discovery to populate the Nexus.</p>
            </div>
         ) : (
